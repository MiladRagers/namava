...
function page() {
  return (
    <div className="my-28 text-white">
      ...
      <div className="max-w-[640px] mx-auto space-y-6 mt-10">
        <div className="bg-namavaBlack flex items-center justify-between py-4 px-5 rounded-lg">
          <div className="space-y-3">
            <h3 className="text-lg">یک ماهه</h3>

            <div className="bg-namava font-Dana text-white px-3 py-1 rounded-2xl text-sm">
          ...
          <div className="flex items-center flex-col gap-y-3">
            <span className="font-Dana text-[#ddd] relative">
              ...
              <span className="block absolute w-[1.5px] h-28 bg-red-600/80 top-1/2 left-1/2 -translate-y-1/2 rotate-[70deg]"></span>
            </span>
        ...
        <div className="bg-namavaBlack flex items-center justify-between py-4 px-5 rounded-lg">
          <div className="space-y-3">
            <h3 className="text-lg">سه ماهه</h3>
        ...
        <div className="bg-namavaBlack flex items-center justify-between py-4 px-5 rounded-lg">
          <div className="space-y-3">
            <h3 className="text-lg">شش ماهه</h3>
        ...
        <div className="py-4 px-5 rounded-lg bg-namavaBlack space-y-3">
          ...
          <ul className="pr-4 list-disc text-sm text-[#d2d2d2]">
            <li>
        ...
        <div className="py-4 px-5 rounded-lg bg-red-700 flex items-center gap-x-5">
          ...
          <div className="space-y-3">
            ...
            <h5 className="text-[#d8d7d7] text-sm">
